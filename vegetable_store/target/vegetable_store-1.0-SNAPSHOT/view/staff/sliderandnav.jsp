...
<div class="bg-white" id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush my-3">
        ...
        <a href="<%= request.getContextPath()%>/staff/order" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                class="fas fa-project-diagram me-2"></i>Order</a>
